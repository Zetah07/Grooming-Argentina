...
const CreateCourse = () => {
  ...
  return (
    <Container className={s.container}>
      <br />
      <h1 className={s.title}>Agregar curso</h1>
      <Form
        noValidate
        className={s.formPd}
        onSubmit={handleSubmit(upVideoCourse)}
      >
        <Form.Group className="d-flex flex-column align-items-start pb-3">
          <Form.Label className={s.label_ccourse}>Título:</Form.Label>
          <Form.Control
            type="text"
        ...
        <Form.Group className="d-flex flex-column align-items-center pb-3">
          <Button className={s.btnZ} type="submit">
            Crear Curso
          </Button>
        </Form.Group>
      </Form>
