...
const PaginationNewsBlogs = ({ totalPages, firstHandler, prevHandler, nextHandler, lastHandler, pages, itemsPerPage, currentPage, pageNumberLimit, maxPageNumberLimit, minPageNumberLimit }) => {
