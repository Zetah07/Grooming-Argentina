...
const ManageBlogsById = () => {
    ...
    }, [dispatch, filter, newId.title, newId.img, newId.description, newId.link, newId.category, newId.provinceOrLocation]);
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            await axios.put(`http://localhost:3500/news/${id}`, formNew, {
