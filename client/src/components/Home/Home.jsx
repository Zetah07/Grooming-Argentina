...
const Home = () => {
  ...
  const getNews = ()=>{
    ...
    axios.get(`http://localhost:3500/news?limit=4&page=1`)
        .then(res=>{
  ...
  return (
    <>
      ...
      <Container>
        <div className={s.carousel1}>
            <h1 className={s.title}>
              Tú <span>colaboración</span> puede ayudarnos mucho
            </h1>
            <div>
              <p>
                This help is focussed towards the poor and the needy who live
                among us within our society and endeavours to bring about a
                change in their life - a "MAATRAM".
              </p>
            </div>
            <div className={s.divBecome}>
              <a href="https://servicios.paypertic.com/formularios/comercios/1466" target='_blank'>
      ...
      <div className={s.carousel2}>
            <h1>
              ¿Por qué <span>debemos </span>  acabar con el Grooming?
            </h1>
            <div>
              <p>
                This help is focussed towards the poor and the needy who live
            ...
            <div className={s.divBecome}>
              <a href="/voluntariado" target='_blank'>
                <button className="button">Ser voluntario</button>
              </a>
            </div>
            </div>
          </Container>
