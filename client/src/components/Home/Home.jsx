  ...
  return (
    <>
      ...
      <div className={s.divSocialMedia}>
        <a href="https://www.instagram.com/groomingargentina/?igshid=YmMyMTA2M2Y%3D/" target="_blank" rel="noreferrer">
        ...
        <a href="https://www.facebook.com/groomingargentina/" target="_blank" rel="noreferrer">
        ...
        <a href="https://twitter.com/GroomingArg/" target="_blank" rel="noreferrer">
          <button className={s.socialMedia}
        ...
        <a href="https://www.tiktok.com/@groomingargentina" target="_blank" rel="noreferrer">
          <button className={s.socialMedia}
