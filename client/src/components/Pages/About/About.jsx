            ...
            <div class="col-sm-12 col-md-12 col-lg-8 col-xl-8 container-fluid p-0">
              <div className={s.textContainer}>
                ...
                <p text="end">
                  ...
                  originada con el propósito de trabajar fundamentalmente sobre
                  ejes basados en la prevención y concientización en pos de la
                  erradicación del grooming en Argentina y América Latina.
                  <br />
                  <br />
                  La ONG se encuentra conformada por un grupo multidisciplinario
                  de profesionales técnicos y voluntarios idóneos no técnicos,
                  destinado a tratar este flagelo que avanza de manera alarmante
                  con el advenimiento de los medios sociales de comunicación y
                  las nuevas tecnologías. El eje central de la Institución está
                  orientado al fortalecimiento de las acciones diarias
                  tendientes a la prevención así como también al acompañamiento
                  y asistencia de las víctimas y sus familias.
                  <br />
                  <br />A su vez, cuenta con la novedosa app de denuncias «GAPP»
                  gratuita y de alcance global, que permite denunciar el delito
                  con tan solo «presionar un botón». Grooming Argentina se
                  encuentra a la vanguardia en materia de promoción y protección
                  de los derechos de niños, niñas y adolescentes en el
            ...
            <div class="col-sm-12 col-md-11 col-lg-8 col-xl-7 container-fluid">
              <div className={s.textContainer2}>
                ...
                <p>
                  ...
                  niños, niñas y adolescentes en el Ecosistema de Internet. Nos
                  dedicamos íntegramente a ejecutar medidas del orden de la
                  promoción y prevención relacionadas a evitar la vulneración de
                  derechos en niños, niñas y adolescentes a través de las
                  distintas plataformas tecnológicas.
                  <br />
                  <br />
                  Las políticas de nuestra Institución están direccionadas y
                  orientadas a proteger el colectivo de niños, niñas y
                  adolescentes así como también el de dinamizar y promover
                  acciones tendientes correspondientes a la formación y
                  capacitación de distintos actores del sistema pertenecientes
                  al mundo adulto.
                  <br />
                  <br />
                  Dichas políticas son ejecutadas de un modo federal en todo el
                  territorio de la República. A su vez, nos encontramos
                  ejecutando dichas políticas en países de la región.
                </p>
              </div>
            </div>
          </div>
            ...
            <div class="col-sm-12 col-md-11 col-lg-8 col-xl-7 container-fluid">
              <div className={s.textContainer2}>
                ...
                <p>
                  ...
                  actuación tanto local como internacional, integrada por
                  personas calificadas e identificadas con la misión y valores
                  institucionales que nos representan, con capacidad de
                  adaptación permanente al cambio y abierta a la coordinación de
                  esfuerzos y recursos con otras organizaciones públicas y
                  privadas.
                </p>
              </div>
            </div>
          ...
          <div class="row g-3">
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
              ...
              <p>
                ...
                particularidad de cada situación compleja que nos toca atravesar
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
              ...
              <p>
                ...
                acciones que nuestra Institución promueve en el territorio
                nacional.
              </p>
            </div>
          </div>
        ...
        <div class="row" className={s.statiticsDiv}>
          <div class="col">
            <div className={s.textContainer}>
              ...
              <h4>
                Nuestras <span>estadísticas</span>
              </h4>
            </div>
          </div>
